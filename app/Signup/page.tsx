            ...
            <div className="w-1/2 bg-[#0F172A] text-white p-12 relative">
                <div className="max-w-md mx-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400">Hello there! Looks like you are new here, Sign Up now.</p>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full p-3 rounded-lg bg-gray-800 border border-gray-700 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition"
                            />
                        </div>
